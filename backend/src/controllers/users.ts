...
> = async (req, res, next) => {
  ...
  const passwordRaw = req.body.password; //  never store raw password info, it will need to be hashed - Explicit naming here makes it easier to distinguish between before and after hashed password whenever we handle this data.
